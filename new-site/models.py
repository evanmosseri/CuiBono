...
# 	name = db.Column(db.String(80,collation='utf-8'))
...
class Legislator(db.Model):
	id = db.Column(db.String(15,collation='utf-8'),primary_key=True)
	filer_id = db.Column(db.INTEGER)
	sources = db.Column(JSON)
	offices = db.Column(JSON)
	first_name = db.Column(db.String(128,collation='utf-8'))
	middle_name = db.Column(db.String(128,collation='utf-8'))
	last_name = db.Column(db.String(128,collation='utf-8'))
	district = db.Column(db.INTEGER)
	party = db.Column(db.String(32,collation='utf-8'))
	photo_url = db.Column(db.String(512,collation='utf-8'))
...
class Bill(db.Model):
	...
	prefix = db.Column(db.String(8,collation='utf-8'))
	number = db.Column(db.INTEGER)
	session = db.Column(db.String(5,collation='utf-8'))
	sources = db.Column(JSON)
	...
	title = db.Column(db.String(5026,collation='utf-8'))
	def __str__(self):
...
class Contributor(db.Model):
	id = db.Column(db.INTEGER,primary_key=True)
	name = db.Column(db.String(512,collation='utf-8'))
	type = db.Column(db.String(8,collation='utf-8'))
	zip = db.Column(db.String(24,collation='utf-8'))
